...
cbPalette <- c("#88CCEE", "#CC6677","#882255", "#332288","#999933","#888888", 
                "#AA4499", "#DDCC77", "#661100", "#6699CC", "#44AA99", "#117733")
##Define order of the data
plt_order <- c("Adaptive","Hierarchical","Thresholding","Percentile","Median","Reader")
...
ggsave("./zR_plots_4abs/spir_FA_tps_barplt.png", plot = fa_tp_bar, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/spir_N4_tps_barplt.png", plot = n4_tp_bar, width = 4.5, height = 3.7, dpi = 300)

ggsave("./zR_plots_4abs/spir_FA_fps_barplt.png", plot = fa_fp_bar, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/spir_N4_fps_barplt.png", plot = n4_fp_bar, width = 4.5, height = 3.7, dpi = 300)

ggsave("./zR_plots_4abs/spir_FA_fns_barplt.png", plot = fa_fn_bar, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/spir_N4_fns_barplt.png", plot = n4_fn_bar, width = 4.5, height = 3.7, dpi = 300)
