...
N4_vdps_mdn <- read.csv("./IRC740H_visit1_spiral_cf/vdp_analysis_results_December2024/N4_combined_vdps.csv")
N4_vdps_mean <- read.csv("./IRC740H_visit1_spiral_cf/vdp_analysis_results_May2025/N4_combined_vdps.csv")

FA_vdps_mdn <- read.csv("./IRC740H_visit1_spiral_cf/vdp_analysis_results_December2024/FA_combined_vdps.csv")
FA_vdps_mean <- read.csv("./IRC740H_visit1_spiral_cf/vdp_analysis_results_May2025/FA_combined_vdps.csv")
...
medn_bxp_n4 <- connected_bxp(long_N4, "AnalysisMethod","VDP", "Subject_id",
                             c(0, 40), cbPalette[c(7, 8)], "", ylabeln4)
...
medn_bxp_fa <- connected_bxp(long_FA, "AnalysisMethod","VDP", "Subject_id",
                             c(0, 40), cbPalette[c(7, 8)], "", ylabelfa)

medn_bxp_fa_p <- calc_add_p(long_FA, "AnalysisMethod", "VDP", medn_bxp_fa,
                            35, tst = "wilcox", paird = TRUE, addp_eq=FALSE)

ggsave("./zR_plots_4ppr/cf_bxp_medn_mean_N4_vdp.png", plot = medn_bxp_n4, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4ppr/cf_bxp_medn_mean_N4_vdp_p.png", plot = medn_bxp_n4_p, width = 4.5, height = 3.7, dpi = 300)

ggsave("./zR_plots_4ppr/cf_bxp_medn_mean_FA_vdp.png", plot = medn_bxp_fa, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4ppr/cf_bxp_medn_mean_FA_vdp_p.png", plot = medn_bxp_fa_p, width = 4.5, height = 3.7, dpi = 300)
