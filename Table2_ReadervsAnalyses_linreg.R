...
N4_rdr_hrar <- linreg_plt(N4_spir_cf_vdps, "Reader", "Hierarchical",
                        expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Hierarchical*" "*VDP[N4]*" "*"(%)")),
                        x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
N4_rdr_adpt <- linreg_plt(N4_spir_cf_vdps, "Reader", "Adaptive",
                          expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Adaptive*" "*VDP[N4]*" "*"(%)")),
                          x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
N4_rdr_prctl <- linreg_plt(N4_spir_cf_vdps, "Reader", "Percentile",
                          expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Percentile*" "*VDP[N4]*" "*"(%)")),
                          x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
N4_rdr_mnlb <- linreg_plt(N4_spir_cf_vdps, "Reader", "Mean",
                           expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Mean[LB]*" "*VDP[N4]*" "*"(%)")),
                           x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
N4_rdr_thrsh <- linreg_plt(N4_spir_cf_vdps, "Reader", "Thresholding",
                          expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Thresholding*" "*VDP[N4]*" "*"(%)")),
                          x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
N4_rdr_mnglb <- linreg_plt(N4_spir_cf_vdps, "Reader", "Median",
                          expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Mean[GLB]*" "*VDP[N4]*" "*"(%)")),
                          x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")

FA_rdr_hrar <- linreg_plt(FA_spir_cf_vdps, "Reader", "Hierarchical",
                          expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Hierarchical*" "*VDP[FA]*" "*"(%)")),
                          x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
FA_rdr_adpt <- linreg_plt(FA_spir_cf_vdps, "Reader", "Adaptive",
                          expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Adaptive*" "*VDP[FA]*" "*"(%)")),
                          x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
FA_rdr_prctl <- linreg_plt(FA_spir_cf_vdps, "Reader", "Percentile",
                           expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Percentile*" "*VDP[FA]*" "*"(%)")),
                           x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
FA_rdr_mnlb <- linreg_plt(FA_spir_cf_vdps, "Reader", "Mean",
                          expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Mean[LB]*" "*VDP[FA]*" "*"(%)")),
                          x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
FA_rdr_thrsh <- linreg_plt(FA_spir_cf_vdps, "Reader", "Thresholding",
                           expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Thresholding*" "*VDP[FA]*" "*"(%)")),
                           x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")
FA_rdr_mnglb <- linreg_plt(FA_spir_cf_vdps, "Reader", "Median",
                           expression(bold(VDP[Reader]*" "*"(%)")), expression(bold(Mean[GLB]*" "*VDP[FA]*" "*"(%)")),
                           x_lim=c(0, 35), y_lim=c(0, 35), corrltn_method="pearson")


# #Save the plot as a png file in the specified directory
ggsave("./zR_plots_4ppr/cf_rdr_N4_hrar_vdp_linreg_plain.png", plot = N4_rdr_hrar[[1]], width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4ppr/cf_rdr_N4_hrar_vdp_linreg_p.png", plot = N4_rdr_hrar[[2]], width = 4.5, height = 3.7, dpi = 300)
