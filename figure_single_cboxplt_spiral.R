...
N4_gre_cf_vdps <- read.csv("./IRC740H_visit1_spiral_cf/vdp_analysis_results_September2024/N4_combined_vdps.csv")
FA_gre_cf_vdps <- read.csv("./IRC740H_visit1_spiral_cf/vdp_analysis_results_September2024/FA_combined_vdps.csv")
# ##Reshape Data to Long Format for ggplot2
N4_data_long <- N4_gre_cf_vdps %>%
  pivot_longer(cols = -Subject_id, names_to = "AnalysisMethod", values_to = "VDP")
FA_data_long <- FA_gre_cf_vdps %>%
  pivot_longer(cols = -Subject_id, names_to = "AnalysisMethod", values_to = "VDP")
...
ggsave("./zR_plots_4abs/spir_vdps_cbxps_N4.png", plot = vdpn4_bxp_nop, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/spir_vdps_cbxps_FA.png", plot = vdpfa_bxp_nop, width = 4.5, height = 3.7, dpi = 300)
