...
#ggsave("./zR_plots_4abs/cf_bxp_adpt_spir_N4_rdr_vdp.png", plot = adpt_bxp_n4, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_adpt_spir_N4_rdr_vdp_p.png", plot = adpt_bxp_n4_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_hrar_spir_N4_rdr_vdp.png", plot = hrar_bxp_n4, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_hrar_spir_N4_rdr_vdp_p.png", plot = hrar_bxp_n4_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_thresh_spir_N4_rdr_vdp.png", plot = thresh_bxp_n4, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_thresh_spir_N4_rdr_vdp_p.png", plot = thresh_bxp_n4_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_prcnt_spir_N4_rdr_vdp.png", plot = prcnt_bxp_n4, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_prcnt_spir_N4_rdr_vdp_p.png", plot = prcnt_bxp_n4_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_medn_spir_N4_rdr_vdp.png", plot = medn_bxp_n4, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_medn_spir_N4_rdr_vdp_p.png", plot = medn_bxp_n4_p, width = 4.5, height = 3.7, dpi = 300)

#ggsave("./zR_plots_4abs/cf_bxp_adpt_spir_FA_rdr_vdp.png", plot = adpt_bxp_fa, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_adpt_spir_FA_rdr_vdp_p.png", plot = adpt_bxp_fa_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_hrar_spir_FA_rdr_vdp.png", plot = hrar_bxp_fa, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_hrar_spir_FA_rdr_vdp_p.png", plot = hrar_bxp_fa_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_thresh_spir_FA_rdr_vdp.png", plot = thresh_bxp_fa, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_thresh_spir_FA_rdr_vdp_p.png", plot = thresh_bxp_fa_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_prcnt_spir_FA_rdr_vdp.png", plot = prcnt_bxp_fa, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_prcnt_spir_FA_rdr_vdp_p.png", plot = prcnt_bxp_fa_p, width = 4.5, height = 3.7, dpi = 300)
#ggsave("./zR_plots_4abs/cf_bxp_medn_spir_FA_rdr_vdp.png", plot = medn_bxp_fa, width = 4.5, height = 3.7, dpi = 300)
ggsave("./zR_plots_4abs/cf_bxp_medn_spir_FA_rdr_vdp_p.png", plot = medn_bxp_fa_p, width = 4.5, height = 3.7, dpi = 300)
